                ...
                <nav className="menu--off">
                    <ul className="header__icons">
                        <li className="header__icons--svg">
                            <a href="https://github.com/GitSepape" rel="noreferrer">
                        ...
                        <li className="header__icons--svg">
                            <a href="https://www.linkedin.com/in/sergio-pascual-2a1230144/" rel="noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <li className="header__icons--svg-last">
                            <a href="https://twitter.com/xSesale" rel="noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
